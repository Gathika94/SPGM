...
from models.GCAN_SPGM1.positional_encoding_layer import positional_encoding_layer
from models.GCAN_SPGM1.GCA_module import GCA_module
from models.GCAN_SPGM1.adaptive_classifier import AdaptiveClassifier
...
import numpy as np
from src.spm1_solver.spm1 import spm1

from src.spm1_solver.pmatnew import PMATA
        ...
        for idx1, idx2 in lexico_iter(range(num_graphs)):
            ...
            if self.training:
                ...
                if True:
                    ...
                    pred_mat = spm1(ss, os,self.wm1,self.rho, n_points[idx1], n_points[idx2])
